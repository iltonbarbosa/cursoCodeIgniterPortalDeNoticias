                ...
                <div class="card-body">
				 ...
				 <?php foreach($usuarios as $u):?>	
                  <tr role="row" class="odd">
                      <td class="sorting_1"><?=$u['user']?></td>
                      <td><a href="#" data-toggle="modal" data-target="#Modal<?=$u['id']?>"><i class="fas fa-key"></i> Mudar Senha</a></td>
                      <td><a href="/controle/usuarios/excluir/<?=$u['id']?>" onclick="return confirm('Confirma exclusão do usuário <?=$u['user']?>?');"><i class="fas fa-trash"></i> Excluir</a></td>
                   </tr>

		<!-- Alterar Senha Modal-->
					  <div class="modal fade" id="Modal<?=$u['id']?>" tabindex="-1" role="dialog" aria-hidden="true">
					    <div class="modal-dialog" role="document">
					      <div class="modal-content">
					        ...
					        <div class="modal-body">
									<form action="<?=base_url('controle/usuarios/editarSenha')?>" method="post">
										<div class="form-group">
